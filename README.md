...
*(Note: Add a screenshot here showing the KQL search bar with your query for the terminated employee, along with the 1 hit returned: `![KQL Post-Termination Query](images/images/Screenshot 2026-06-12 142212.png)`)*
